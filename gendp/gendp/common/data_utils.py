...
def d3fields_proc(fusion, shape_meta, color_seq, depth_seq, extri_seq, intri_seq,
    ...
    # use_seg = False
    # use_dino = True
    # print(f"[data_utils] shape_meta['info'] {shape_meta['info']}")
    ...
    # print(f"[data_utils] N_total {N_total}")
    ...
    for t in range(T):
        ...
        elif 'xarm' in teleop_robot.robot_name:
        ...
        if use_seg:
            ...
            obj_pcd = fusion.extract_pcd_in_box(boundaries=boundaries, downsample=True, downsample_r=0.002, excluded_pts=None, exclude_threshold=None, exclude_colors=[])
